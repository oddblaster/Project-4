...
class SudokuGenerator:
    ...
    def fill_box(self, row_start, col_start):
        ...
        for row in range(row_start, row_start + 3):
            for col in range(col_start, col_start + 3):
                # construct list of viable numbers for (row, col)
                viable = [num for num in remaining if self.valid_in_row(row, num) and self.valid_in_col(col, num)]
                rand = random.choice(viable)
